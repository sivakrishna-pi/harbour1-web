...
<?php include('findingfanny.php');include('anybodycandance_v3.php');
...
"></span></div>
              <script type="text/javascript">
                /*$(document).ready(function () {
                  if($('select[name=packmonths]').val()==1){
                    document.getElementById("terms1").textContent="Total bill is for first month only. ";
                    document.getElementById("terms2").textContent="Subsequent invoices will be generated on monthly basis hereafter";

                  }else if($('select[name=packmonths]').val()==2){
                    document.getElementById("terms1").textContent="Total bill is for first month only. ";
                    document.getElementById("terms2").textContent="Subsequent invoices will be generated on monthly basis hereafter";

                  }
              else if($('select[name=packmonths]').val()==3){
                    document.getElementById("terms1").textContent="Total bill is for first quarter only.";
                    document.getElementById("terms2").textContent="Subsequent invoices will be generated on monthly basis hereafter";

                  }else if($('select[name=packmonths]').val()==6){
                    document.getElementById("terms1").textContent="Total bill is for first six months only.";
                    document.getElementById("terms2").textContent="Subsequent invoices will be generated on monthly basis hereafter";
                    
                  }else if($('select[name=packmonths]').val()==12){
                    document.getElementById("terms1").textContent="Total bill is for first twelve months only.";
                    document.getElementById("terms2").textContent="Subsequent invoices will be generated on monthly basis hereafter";
                    
                  }else{
                    document.getElementById("terms1").textContent="Total bill is for first twelve months only.";
                    document.getElementById("terms2").textContent=$('select[name=packmonths]').val()+"1Subsequent invoices will be generated on monthly basis hereafter";

                  }
            });

            $("#monthspack").change(function () {
              if($('select[name=packmonths]').val()=='1'){
                    document.getElementById("terms1").textContent="Total bill is for first month only. ";
                    document.getElementById("terms2").textContent="Subsequent invoices will be generated on monthly basis hereafter";
...
<input type="hidden" name="packips[]" class="packips" value="<?php echo $ip_num[$q];?>">
     ...
     <input type="hidden" name="packos_total[]" class="packos_total" value="<?php echo $packos_total[$q];?>">
                    ...
                    <select class="packmonths changepricing finselet" id="monthspack" name="packmonths[]">
...
<input type="checkbox" name="terms" style="margin-left: -97%;"> I have read and agree to the following <a target="_blank" href="https://pidatacenters.com/terms-conditions/" rel="nofollow" >Terms and conditions</a>
...
<table>
           ...
           <tr class="grprice-rt" style="width: 100%; margin-top: 5px; background: #0b3509;">
           ...
           <!-- <br>
            ...
            <tr class="grprice-rt" style="background: #41ab3c; width: 100%; margin-top: 5px; padding: 4px;" >
      ...
      <tr class="grprice-rt" style=" background: #0b3509; width: 100%; margin-top: 5px;" >
...
<script type="text/javascript" src="js/custom-script_v4.js?07102017"></script> 
