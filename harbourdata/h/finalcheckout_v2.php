...
<?php include('findingfanny.php');include('anybodycandance_v2.php');
...
<div class="main-cart">
  ...
  <form method="post" onsubmit="return validateForma()" id="form_validate" name="form_property" action="<?php echo $baseurl;?>/pidata/p/plans/orders_v2.php">
      ...
      ?>
                ...
                <tbody class="qwesr">
                  ...
                  <tr>
                    ...
                    <td colspan="4"><h4 class="review-ord-subtitle bold"><?php echo $plansSelected;?> </h4></td>

                  </tr>

                  <tr class="">

                    <td><label class="dbmargin2"> <?php echo $packselectedsub;?></label></td>
                    <td><span style="padding-left: 12px;"><?php echo $qtt;?> Units</span></td>
                    ...
                    <input type="hidden" name="packid[]" class="packid" value="<?php echo $packid;?>">
                      ...
                      <input type="hidden" name="planprice[]" class="planprice" value="<?php echo $planPrice;?>">
...
<input type="hidden" name="packips[]" class="packips" value="<?php echo $packips;?>">
            ...
            <input type="hidden" name="packipn[]" class="packipn" value="<?php echo $ip_total;?>">
   ...
   <input type="hidden" name="plandiscount[]" class="plandiscount" value="<?php echo round($discount);?>">
                      ...
                      <input type="hidden"  class="packmonths changepricing " name="packmonths[]" value="<?php echo $packmonths;?>">

                      <input type="hidden"  class="incss changepricings123 " name="packqtt[]" value="<?php echo $qtt;?>">

                       <span style="padding-left: 12px;"><?php if($packmonths==1){echo "Monthly";}
                       else if($packmonths==3){
                        echo "1 year (Quarterly Advance)";

                       }else if($packmonths==6){
                        echo "1 year (50% Advance)";
                       }else if($packmonths==12){
                        echo "1 year (100% Advance)";
                      }else if($packmonths==24){
                        echo "2 year (100% Advance)";
                      }else if($packmonths==36){
    ...
    padding-right: 14px;">Rs <span class="subbrtor"><?php echo $planprice2;?></span></td>
                  ...
                  <th colspan="3"> <div class="myspan"><label  style="color: #20641b;font-weight: bold;font-size: 14px; }" class="myterms123 dbmargin2"> 
                   ...
                   else if($packmonths==6){echo "Total bill is for first six months only. Subsequent invoices will be generated on half yearly basis hereafter.";} 
                   ...
                   else if($packmonths==36){echo "Total bill is for the period of three year in full.";} ?></label></div>
</th>
...
<a href="<?php echo $baseurl;?>/pidata/p/pricing_cloud_servers.php"  class="bold qazxcv white-by">Close</a>
            ...
            <div class="makepaymdnt">
              ...
              <div class="pay-title">
                ...
                <h4 class="bold pull-right">Rs <span class="grandtrunk2"><?php echo 
                moneyFormatIndia
              (
                (array_sum($planprice_array)+
                  ((int)array_sum($otc_item_array)))+(int)
                ((
                  ((int)array_sum($planprice_array))+
                  ((int)array_sum($otc_item_array))
...
<script type="text/javascript" src="js/custom-script_v4.js?20102017"></script> 
...
$(document).ready(function() {
    ...
    if(checkemailb($('input[name="emr"]').val()) && $('input[name="emrname"]').val()!='' && $('input[name="emrcompany"]').val()!=''){
      ...
      if(checkmobilee($('input[name="emoble"]').val())){
        $(".loginajax_reg").prop('disabled', true);
      event.preventDefault();
      ...
      $.ajax({
        ...
        success: function(result){
        	 $(".loginajax_reg").prop('disabled', false);
