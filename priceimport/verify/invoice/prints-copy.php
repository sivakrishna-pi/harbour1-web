...
$mpdf->SetDisplayMode('fullpage');
	...
	$mpdf->SetHTMLFooter("<div style='width:95%;'><hr></div><table width='95%' style=' padding-bottom:25px;'><tr><td width='30%' align='left' style='font-size:12px;'>©2019 Pi DATACENTERS</td><td width='40%' align='center' style='font-size:12px;'><img style='margin-top:0px;' src='../images/lock-icon.png'/>100 % Safe & Secure Payments</td><td align='right' width='30%' style='font-style: italic;font-size:12px;'>{PAGENO}/{nbpg}</td></tr></table>");
