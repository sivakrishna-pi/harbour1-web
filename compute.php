...
<div class="hb-bannerCont">
	<div class="hb-bannerImgCont">
		<div class="hb-bannerImg">
			<picture>
			     <source media="(max-width: 768px)" srcset="images/banners/compute_banner.png">
			      <img  src="images/banners/compute_mbanner.png" alt="Harbour1 Cloud Backup as a Service Banner" style="width:100%">
      		</picture>
		</div>		
	</div>
</div>
	...
	<section id="hb_products_Lists">
		<div class="container">
			<div class="hb-productHead text-center">
				...
				<p>Let us manage your IT  infrastructure, while you manage your business. Instead of investing into building your IT infrastructure grounds up  and hassling through the maintenance of it, accelerate your digital transformation with high-performance compute on Harbour1<sup>®</sup>.</p>
			</div>
			            ...
			            <ul class="hb-productSec list-inline">
			            	<li>
			            		<div class="hb-leftCont hb_ppCont">
			            			<span>
			            				<img src="images/product-images/vm_img.png" alt="tickmark">
			            			</span>
			            		</div>
			            	</li>
			            	<li>
			            		<div class="hb-rightCont hb_ppCont">
			            			...
			            			<p>Accelerate your digital transformation with Virtual servers offering a stable, secure, highly available and easy to deploy environments for your data and applications. Choose a hypervisor of your choice and integrate your multi cloud environments with Harbour1<sup>®</sup>. </p>
			            		</div>
			            	</li>
			            </ul>
			            	...
			            	<ul class="list-inline hb-featuresList">
			            		<li>
			            			<div class="hb-featureBox">
			            				<div class="hb-featTopHeader">
			            					<p class="hb-featLogo">
			            						<img src="images/scale-3.svg" alt="scale">
			            					</p>
			            		...
			            		<li>
			            			<div class="hb-featureBox">
			            				<div class="hb-featTopHeader">
			            					<p class="hb-featLogo">
			            						<img src="images/Economics.svg" alt="economics">
			            					</p>
			            					<div class="hb-featCont">
			            		...
			            		<li>
			            			<div class="hb-featureBox">
			            				<div class="hb-featTopHeader">
			            					<p class="hb-featLogo">
			            						<img src="images/Self.svg" alt="Self">
			            					</p>
			            					<div class="hb-featCont">
			            	...
			            	<ul class="list-inline hb-idealList">
			            		<li>
			            			<div class="hb-idealFet">
			            				<span>
			            					<img src="images/Tick.svg" alt="tickmark">
			            				</span>
			          ...
			          <ul class="hb-productSec list-inline">
			            	<li>
			            		<div class="hb-leftCont hb_ppCont">
			            			...
			            			<p>Harbour1<sup>®</sup> offers a robust container orchestration and management technology to deploy and manage containers at scale. The environment provisioned on Harbour1<sup>®</sup> enables developers to use abstraction and isolation technology to package an application, and all the files needed to run it, in a way that isolates the application from the underlying host OS.  </p>
			            		</div>
			            	</li>
			            	<li>
			            		<div class="hb-rightCont hb_ppCont">
