...
<div class="payment-ack-header">
  ...
  <article class="col-md-8">
      ...
      <b>'.$_REQUEST['svname1'].'</b><br>

      <span style="font-size:14px;">Company Name: <span class="bold">'.$_REQUEST['copmans1'].'</span></span><br>

      <span style="font-size:14px;">Email ID: <span class="bold">'.$_REQUEST['emailll1'].'</span></span><br>

      <span style="font-size:14px;">Mobile Number '.$_REQUEST['svmob1'].'</span><br>
...
<td style="line-height:30px; color:#FFF;width: 35%;">&nbsp;&nbsp;Product Details</td>

<td style="line-height:30px; color:#FFF; text-align:center;width: 40%;">Tenure</td>

<td style="line-height:30px; color:#FFF; text-align:center;width: 25%;">Price</td>

</tr>';

for($gg=0;$gg<count($_SESSION['plan_proposal']['packid']);$gg++){

$body.='<tr>';

                    
                    $body.='<td colspan="5"><h3 class="ack-title bold">'.$_SESSION['plan_proposal']['packselected'][$gg].'</h3></td>';

                    $body.='</tr>';

                    $body.='<tr class="bdrr">';
                    $body.='<td><h5 class="ack-subtitle bold">'.$_SESSION['plan_proposal']['packselectedsub'][$gg].'</h5>';



										
										if($_SESSION['plan_proposal']['packram'][$gg]>'0')$body.='<p style="Margin:0;padding:0;line-height:20px;color:#262626;text-indent:14px;"><small>Ram: '.$_SESSION['plan_proposal']['packram'][$gg].' GB</small></p>';
										if($_SESSION['plan_proposal']['packcpu'][$gg]>'0')$body.='<p style="Margin:0;padding:0;line-height:20px;color:#262626;text-indent:14px;"><small>CPU: '.$_SESSION['plan_proposal']['packcpu'][$gg].' Cores</small></p>';
										if($_SESSION['plan_proposal']['packdata'][$gg]>'0')$body.='<p style="Margin:0;padding:0;line-height:20px;color:#262626;text-indent:14px;"><small>Data Transfer: '.$_SESSION['plan_proposal']['packdata'][$gg].' GB</small></p>';
										if($_SESSION['plan_proposal']['packspace'][$gg]>'0')$body.='<p style="Margin:0;padding:0;line-height:20px;color:#262626;text-indent:14px;"><small>Disk Space: '.$_SESSION['plan_proposal']['packspace'][$gg].' GB</small></p>';

										if($_SESSION['plan_proposal']['packbackup'][$gg]>'0')$body.='<p style="Margin:0;padding:0;line-height:20px;color:#262626;text-indent:14px;"><small>Backup: '.$_SESSION['plan_proposal']['packbackup'][$gg].' GB</small></p>';
										if($_SESSION['plan_proposal']['packips'][$gg]>'0')$body.='<p style="Margin:0;padding:0;line-height:20px;color:#262626;text-indent:14px;"><small>IPs: '.$_SESSION['plan_proposal']['packips'][$gg].'</small></p>';
										if($_SESSION['plan_proposal']['packdrive'][$gg]>'0')$body.='<p style="Margin:0;padding:0;line-height:20px;color:#262626;text-indent:14px;"><small>Drive: '.$_SESSION['plan_proposal']['packdrive'][$gg].'</small></p>';
										...
										if($_SESSION['plan_proposal']['packos'][$gg]>'0')$body.='<p style="Margin:0;padding:0;line-height:20px;color:#262626;text-indent:14px;"><small>OS: '.$_SESSION['plan_proposal']['packos'][$gg].'</small></p>';
										
										
 			if($_SESSION['plan_proposal']['packdb'][$gg]!=='' && $_SESSION['plan_proposal']['packdb'][$gg]!=='0' && $_SESSION['plan_proposal']['packdb'][$gg]>'0'){                

                    if($_SESSION['plan_proposal']['packdb'][$gg]=="MS SQL Enterprise*"){
                    ...
                    }else if($_SESSION['plan_proposal']['packdb'][$gg]=="MS SQL Standard*"){
                    ...
                    }else if($_SESSION['plan_proposal']['packdb'][$gg]=="MS SQL Web*"){
                    ...
                    $body.='<p style="Margin:0;padding:0;line-height:20px;color:#262626;text-indent:14px;"><small><font color="red">*</font>2 core license cost included</small></p>';
                      ...
                      $body.='<p style="Margin:0;padding:0;line-height:20px;color:#262626;text-indent:14px;"><small>Database: '.$_SESSION['plan_proposal']['packdb'][$gg].'</small></p>';
                  }
              }
										if($_SESSION['plan_proposal']['packmonths'][$gg]>'0')if($_SESSION['plan_proposal']['packmonths'][$gg]=='1'){$tenure= "Monthly";}
                       else if($_SESSION['plan_proposal']['packmonths'][$gg]=='3'){
                        $tenure= "1 year (Quarterly Advance)";

                       }else if($_SESSION['plan_proposal']['packmonths'][$gg]=='6'){
                        $tenure= "1 year (50% Advance)";
                       }else if($_SESSION['plan_proposal']['packmonths'][$gg]=='12'){
                        $tenure= "1 year (100% Advance)";
                      }else if($_SESSION['plan_proposal']['packmonths'][$gg]=='24'){
                        $tenure= "2 year (100% Advance)";
                      }else if($_SESSION['plan_proposal']['packmonths'][$gg]=='36'){
                        $tenure= "3 year (100% Advance)";
                      }
                      if($_SESSION['plan_proposal']['packmonths'][$gg]==1){$terms = "Total bill is for first month only. Subsequent invoices will be generated on monthly basis hereafter. Unless there is a cancellation.";}
                   else if($_SESSION['plan_proposal']['packmonths'][$gg]==3){$terms = "Total bill is for first quarter only. Subsequent invoices will be generated on quarterly basis hereafter.";}
                   else if($_SESSION['plan_proposal']['packmonths'][$gg]==6){$terms = "Total bill is for first six months only. Subsequent invoices will be generated on half yearly basis hereafter.";} 
                   else if($_SESSION['plan_proposal']['packmonths'][$gg]==12){$terms = "Total bill is for the period of one year in full.";}
                   else if($_SESSION['plan_proposal']['packmonths'][$gg]==24){$terms = "Total bill is for the period of two year in full.";}
                   else if($_SESSION['plan_proposal']['packmonths'][$gg]==36){$terms = "Total bill is for the period of three year in full.";}
                      ...
                      $body.='<td style="text-align:right"><span class="bold spntotal">Rs  '.moneyFormatIndia($_SESSION['plan_proposal']['planprice'][$gg]).'</span></td>';

										
$body.='</tr>';

$tax[] = $_SESSION['plan_proposal']['planprice'][$gg];

$otc[] = $_SESSION['plan_proposal']['otc123'][$gg];
}

$body.='</table>
<br><br>
<p style="font-weight:600;Margin:0;padding:0;line-height:25px;color:#12314e; text-align:right;Margin-top: -23px;"><span style="border-bottom:1px solid #ccc;padding:0 10px 5px 10px;">OTC : Rs '.moneyFormatIndia((int)(array_sum($otc))).'</span></p>
<br>

<p style="font-weight:600;Margin:0;padding:0;line-height:25px;color:#12314e; text-align:right;Margin-top: -23px;"><span style="border-bottom:1px solid #ccc;padding:0 10px 5px 10px;">GST (18%): Rs '.moneyFormatIndia((int)((array_sum($tax)+array_sum($otc))*0.18)).'</span></p>

<hr>

<div class="text-right" align="right">

<b style="font-size:16px;">Total Amount <span class="bold"> Rs  '.moneyFormatIndia(
  (int)(array_sum($tax)+array_sum($otc)+((array_sum($tax)+array_sum($otc))*0.18))).'</span></b>
...
<td style="text-align: center; padding: 15px;" width="238">One Year Contract; Half-yearly payment in advance, subsequent invoices will be generated on quarterly advance basis hereafter</td>
<td style="text-align: center; padding: 15px;" width="97">√</td>
<td style="text-align: center; padding: 15px;" width="154">√</td>
</tr>
<tr>
...
//$_SESSION['animal']   = 'cat';
//$_SESSION['diff_id']     = $diff_id;

  //$filename='../Plan_proposal-'.$diff_id;
  //$filename='Plan proposal';
