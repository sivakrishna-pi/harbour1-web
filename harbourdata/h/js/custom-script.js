...
var sum = 0;
    ...
    //sum=sum+otc;
var intsum=parseInt(sum);
var inttax=parseInt((sum+otc)*0.18);

    $('.grandtrunk').text(inrFormat(intsum));
    $('.otctotal').text(inrFormat(otc));
    $('.grandtax').text(inrFormat(inttax));
    $('.grandtrunk2').text(inrFormat(intsum+inttax+otc));
...
function session_destroy(){
    ...
    function priceuopdating($india){
        ...
        $india.find('.myterms123').text("Total bill is for first quarter only. Subsequent invoices will be generated on quarterly basis hereafter.");
            ...
            $india.find('.myterms123').text("Total bill is for first six months only. Subsequent invoices will be generated on quarterly basis hereafter.");
        ...
        if(months=='3'){price=price;
            ...
            $india.find('.myterms123').text("Total bill is for first six months only. Subsequent invoices will be generated on monthly basis hereafter.");
